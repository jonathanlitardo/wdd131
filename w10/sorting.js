...
console.log("Ascending sort:", anotherSort);
...
const descendingSort = simpleList.sort(compareFnDesc);
...
function searchListObjects(list, q) {
    ...
    const sorted = filtered.sort((a, b) => {
        // Parse the distance strings to get numeric values for proper comparison
...
console.log('Search for "yellowstone":', searchListObjects(hikes, "yellowstone"));
console.log('Search for "moderate":', searchListObjects(hikes, "moderate"));
console.log('Search for "al":', searchListObjects(hikes, "al"));